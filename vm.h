...
typedef enum{
	...
	,OP_LOAD_F			// take an adress from stack and puts back the float value from that address
	,OP_NOP				// no operation
	,OP_SUB_I			// subtracts 2 int values from the top of the stack and puts the result on stack
	,OP_SUB_F			// subtracts 2 float values from the top of the stack and puts the result on stack
	,OP_DIV_I			// divides 2 int values from the top of the stack and puts the result on stack
	,OP_DIV_F			// divides 2 float values from the top of the stack and puts the result on stack
	,OP_MUL_F			// multiplies 2 float values from the top of the stack and puts the result on stack
	...
	,OP_STORE_F			// takes from the stack an address and a float value and puts the value at the specified address. Leaves the value on stack.
}Opcode;
